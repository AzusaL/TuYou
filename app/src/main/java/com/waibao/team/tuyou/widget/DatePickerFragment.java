...
//    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final DatePickerDialog datePickerDialog = new DatePickerDialog(context, R.style.DataPickerDialogTheam,this, year, month, day);
        if (maxToday) {
    ...
    private void dateSet(int year, int monthOfYear, int dayOfMonth) {
        ...
        if (mDateSet != null) {
            mDateSet.dateSetResult(DateUtil.getStringByFormat(c.getTimeInMillis(), DateUtil.dateFormatYMD), false);
        }
    }
